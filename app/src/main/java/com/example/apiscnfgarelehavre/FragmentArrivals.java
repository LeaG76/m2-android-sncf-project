...
public class FragmentArrivals extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        TextView textViewDate = view.findViewById(R.id.text_date_arrivals);
        ...
        TextView textViewHour= view.findViewById(R.id.text_hour_arrivals);
        textViewHour.setText("Il est " + formattedHour);

        ArrayList<String> train_date_list = MainActivity.train_arrival_Date;
        ArrayList<String> train_direction_list = MainActivity.train_arrival_Direction;
        ArrayList<String> train_type_list = MainActivity.train_arrival_Type;
        ArrayList<String> train_number_list = MainActivity.train_arrival_Number;
